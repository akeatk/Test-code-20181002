...
if(true){
  ...
  if(true)
    for(let i = 0;i < len;i++){
      r1[i] = Math.sin(5+Math.PI*2*i * (fss * 6.5));
          // + 7/8*Math.sin(2+Math.PI*2*i * (fss * 6))
          // + 6/8*Math.sin(5+Math.PI*2*i * (fss * 7))
          // + 5/8*Math.sin(6+Math.PI*2*i * (fss * 8.5))
          // + 4/8*Math.sin(5+Math.PI*2*i * (fss * 9))
          // + 3/8*Math.sin(7+Math.PI*2*i * (fss * 10));
      i1[i] = 0;
    }
  else{
