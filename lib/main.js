  ...
  if(true)
    for(let i = 0;i < len;i++){
      r1[i] = Math.sin(5+Math.PI*2*i * (fss * 5))
          + 0.9*Math.sin(3+Math.PI*2*i * (fss * 6))
          + 0.8*Math.sin(3+Math.PI*2*i * (fss * 7))
          + 0.7*Math.sin(3+Math.PI*2*i * (fss * 8))
          + 0.6*Math.sin(3+Math.PI*2*i * (fss * 9))
          + 0.5*Math.sin(3+Math.PI*2*i * (fss * 10));
      i1[i] = 0;
    }
  else{
