...
if(true){
  ...
  if(true)
    for(let i = 0;i < len;i++){
      r1[i] = 1/8 * Math.sin(5+Math.PI*2*i * (fss * 5))
          + 1/8*Math.sin(2+Math.PI*2*i * (fss * 6))
          + 1/8*Math.sin(3+Math.PI*2*i * (fss * 7))
          + 1/8*Math.sin(6+Math.PI*2*i * (fss * 8))
          + 1/8*Math.sin(5+Math.PI*2*i * (fss * 9))
          + 1/8*Math.sin(7+Math.PI*2*i * (fss * 10));
      i1[i] = 0;
    }
  else{
